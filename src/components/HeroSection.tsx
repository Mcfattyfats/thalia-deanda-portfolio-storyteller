    ...
    <section className="min-h-screen flex items-center justify-center pt-20 pb-section px-8">
      <div className="container mx-auto max-w-6xl">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          {/* Hero Content */}
          <div className={`flex flex-col justify-between h-full ${isVisible ? 'animate-slide-up animation-delay-200' : 'opacity-0'}`}>
            <div className="aspect-[4/5] flex flex-col justify-between py-8">
              <div>
                <h1 className="text-xl font-normal text-portfolio-white mb-6">
                  award-winning digital marketing strategist
                </h1>
                
                <div className="space-y-4 body-text text-sm leading-relaxed">
                  <p>
